...
`,
  ...
  describe("calculateTrustScore", () => {
    it("should calculate trust score based on usage and success rate", () => {
      ...
      expect(patternManager.calculateTrustScore(10, 0.8)).toBeGreaterThan(0.7);
      expect(patternManager.calculateTrustScore(2, 0.9)).toBeLessThan(0.8);
    });
  ...
  describe("getStarRating", () => {
    it("should return correct star ratings", () => {
      ...
      expect(patternManager.getStarRating(0.4)).toBe("★☆☆☆☆");
    });
  });
  ...
  describe("findRelevantPatterns", () => {
    it("should find patterns matching task description", async () => {
      const patterns = await patternManager.findRelevantPatterns(
