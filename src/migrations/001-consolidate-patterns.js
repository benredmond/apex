            ...
            for (const draft of drafts) {
                try {
                    ...
                    const digest = crypto
                        ...
                        .digest('hex');
                    insertStmt.run(patternId, '1.0.0', // schema version
                    '1.0.0', // pattern version
                    type, patternData.title, patternData.summary, initialTrustScore, draft.created_at, draft.created_at, digest, jsonCanonical, 1.0, // alpha (Beta distribution)
